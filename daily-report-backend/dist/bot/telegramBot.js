...
if (exports.bot) {
    const sessionPath = path_1.default.resolve(process.cwd(), 'telegram_sessions.json');
    ...
    const localSession = new telegraf_session_local_1.default({ database: 'telegram_sessions.json' });

...
const ACCESS_EXPIRES_IN = (process.env.ACCESS_TOKEN_EXPIRES_IN || '12h') as any;
...
export const SESSION_TIMEOUT_MS = Math.max(1, Number.isFinite(SESSION_TIMEOUT_HOURS) ? SESSION_TIMEOUT_HOURS : 168) * 60 * 60 * 1000;
